...
app.config['MAIL_PASSWORD'] = os.environ.get('MAIL_PASSWORD')  # Recupera la password dalla variabile d'ambiente
...
def add_location():
    ...
    if latitude and longitude:
        ...
        msg = Message("Nuova posizione condivisa",
                      recipients=["destinatario@example.com"])  # Sostituisci con l'indirizzo email destinatario
